set moduleName matrixMul_matrixMul_TRN_10_wrapper
...
set isOneStateSeq 0
set C_modelName {matrixMul_matrixMul_TRN_10_wrapper}
...
set C_modelArgList {
	...
	{ Csub_block_block0 float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ c_block0 int 32 regular  }
	{ wB int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "blockDim_x", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "Csub_block_block0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "c_block0", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ Csub_block_block0_address0 sc_out sc_lv 8 signal 4 } 
	{ Csub_block_block0_ce0 sc_out sc_logic 1 signal 4 } 
	{ Csub_block_block0_q0 sc_in sc_lv 32 signal 4 } 
	{ c_block0 sc_in sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Csub_block_block0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "Csub_block_block0", "role": "address0" }} , 
 	{ "name": "Csub_block_block0_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Csub_block_block0", "role": "ce0" }} , 
 	{ "name": "Csub_block_block0_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Csub_block_block0", "role": "q0" }} , 
 	{ "name": "c_block0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "c_block0", "role": "default" }} , 
 	{ "name": "wB", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "wB", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "matrixMul_matrixMul_TRN_10_wrapper", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		...
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_matrixMul_matrixMul_TRN_10_fu_58", "Parent" : "0", "Child" : [], "CDFG" : "matrixMul_matrixMul_TRN_10", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "blockDim_x", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "blockDim_y", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "blockDim_z", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
...
set Spec2ImplPortList { 
	...
	Csub_block_block0 { ap_memory {  { Csub_block_block0_address0 mem_address 1 8 }  { Csub_block_block0_ce0 mem_ce 1 1 }  { Csub_block_block0_q0 mem_dout 0 32 } } }
	c_block0 { ap_none {  { c_block0 in_data 0 32 } } }
