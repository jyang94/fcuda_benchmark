...
#pragma fcuda compute name=CMP_6 end=false cores=1 begin=true 
...
#pragma fcuda transfer cores=1 size=[BLOCKDIM_X] name=TRN_11 end=false begin=true 
...
#pragma fcuda transfer cores=1 size=[BLOCKDIM_X] name=TRN_7 end=false begin=true 
...
#pragma fcuda compute name=SNC_8 end=false cores=1 begin=true 
